...
Controllers are created by :ref:`inheriting <python:tut-inheritance>` from :class:`~flectra.http.Controller`.
Routes are defined through methods decorated with :func:`~flectra.http.route`::
