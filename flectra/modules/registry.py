...
import flectra
from flectra.modules.db import FunctionStatus
...
from flectra.tools.func import locked
...
class Registry(Mapping):
    ...
    def new(cls, db_name, force_demo=False, status=None, update_module=False):
        ...
        try:
            ...
            try:
                flectra.modules.load_modules(registry, force_demo, status, update_module)
            except Exception:
    ...
    def init(self, db_name):
        ...
        self._assertion_report = flectra.tests.result.FlectraTestResult()
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = flectra.modules.db.has_unaccent(cr)
            self.has_trigram = flectra.modules.db.has_trigram(cr)
    ...
    def cursor(self):
        ...
        if self.test_cr is not None:
            ...
            return TestCursor(self.test_cr, self.test_lock, current_test=flectra.modules.module.current_test)
