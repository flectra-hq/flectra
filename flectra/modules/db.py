...
def initialize(cr):
    ...
    """
    try:
        f = flectra.tools.misc.file_path('base/data/base_data.sql')
    ...
    for i in flectra.modules.get_modules():
        ...
        info = flectra.modules.get_manifest(i)
...
def has_trigram(cr):
    ...
    pg_trgm module but any similar function will be picked by Flectra.
