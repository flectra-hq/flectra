...
from flectra.tools.misc import file_open, mute_logger
from flectra.tools.translate import _, _lt, TranslationFileReader, TranslationModuleReader
...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        flectra.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
    ...
    def test_noupdate(self):
        ...
        flectra.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False, overwrite=True)
    ...
    def test_lang_with_base(self):
        ...
        flectra.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_BE', verbose=False)
        flectra.tools.trans_load(self.cr, 'test_translation_import/i18n/fr_BE.po', 'fr_BE', verbose=False, overwrite=True)
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(create_empty_translation=False):
            ...
            with closing(io.BytesIO()) as bufferobj:
                flectra.tools.trans_export('fr_FR', ['test_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_translation_import/i18n/fr.po'
                flectra.tools.trans_load_data(self.cr, bufferobj, 'po', 'fr_FR',
                                           verbose=False,
    ...
    def test_translation_placeholder(self):
        ...
        with self.assertLogs('flectra.tools.translate', 'ERROR'):
            self.assertEqual(
                _("Text with %s placeholder", 1),
