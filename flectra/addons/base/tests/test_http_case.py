...
from flectra.tests.common import HttpCase, tagged, ChromeBrowser
...
class TestChromeBrowser(HttpCase):
    def setUp(self):
        ...
        with patch.dict('flectra.tools.config.options', {'screencasts': screencasts_dir, 'screenshots': config['screenshots']}):
