...
import flectra
from flectra.sql_db import db_connect, TestCursor
from flectra.tests import common
from flectra.tests.common import BaseCase
from flectra.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = flectra.api.Environment(self.cr, flectra.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('flectra.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:flectra.sql_db:Found different un-closed cursor', msg)
