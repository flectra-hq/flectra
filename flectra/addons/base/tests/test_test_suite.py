...
from flectra.tests.case import TestCase
from flectra.tests.common import BaseCase, TransactionCase, users, warmup
from flectra.tests.result import FlectraTestResult

_logger = logging.getLogger(__name__)

from flectra.tests import MetaCase
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _check_log_records(self, log_records):
        ...
        for log_record in log_records:
            ...
            self._assert_log_equal(log_record, 'name', 'flectra.addons.base.tests.test_test_suite')
    ...
    def _clean_message(self, message):
        root_path = PurePath(__file__).parents[4]  # removes /flectra/addons/base/tests/test_test_suite.py
        ...
        message = message.replace(f'"{root_path}', '"/root_path/flectra')
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_raise_subtest
...
Traceback (most recent call last):
  ...
  File "/root_path/flectra/flectra/tests/common.py", line $line, in _users
    func(*args, **kwargs)
  File "<decorator-gen-xxx>", line $line, in test_with_decorators
  File "/root_path/flectra/flectra/tests/common.py", line $line, in warmup
    func(*args, **kwargs)
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_with_decorators
    raise Exception('This is an error')
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_call_stack
    alpha()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in beta
    gamma()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in gamma
    raise Exception('This is an error')
Exception: This is an error
''')
        self.expected_logs = [
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_call_stack_context_manager
    alpha()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_call_stack_subtest
    alpha()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_assertQueryCount
    with self.assertQueryCount(system=0):
  File "/usr/lib/python/contextlib.py", line $line, in __exit__
    next(self.gen)
  File "/root_path/flectra/flectra/tests/common.py", line $line, in assertQueryCount
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_reraise
    alpha()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in alpha
    beta()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in beta
...
Traceback (most recent call last):
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in test_handle_error
    alpha()
  File "/root_path/flectra/flectra/addons/base/tests/test_test_suite.py", line $line, in alpha
    raise Exception('This is an error2')
