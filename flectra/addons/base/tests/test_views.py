...
from flectra.tools import get_cache_key_counter, mute_logger, view_validation, safe_eval
from flectra.addons.base.models import ir_ui_view
...
class ViewCase(TransactionCaseWithUserDemo):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False):
        with mute_logger('flectra.addons.base.models.ir_ui_view'):
