...
from flectra.tools import mute_logger, view_validation
from flectra.addons.base.models.ir_ui_view import (
...
class TestViews(ViewCase):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view'):
        with self.assertRaises(ValidationError) as catcher, mute_logger('flectra.addons.base.models.ir_ui_view'):
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('flectra.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
