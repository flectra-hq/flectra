...
from flectra.tests.common import BaseCase, TransactionCase, RecordCapturer, get_db_name, tagged
...
class TestIrCron(TransactionCase, CronMixinCase):
    ...
    def test_cron_null_interval(self):
        ...
        self.cron.flush_recordset()
        with self.assertLogs('flectra.addons.base.models.ir_cron', 'ERROR'):
