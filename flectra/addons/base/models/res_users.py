...
from flectra.tools import partition, collections, frozendict, lazy_property, image_process
...
class Users(models.Model):
    ...
    def _get_default_image(self):
        """ Get a default image when the user is created without image
            ...
            https://github.com/flectra/flectra/blob/11.0/flectra/addons/base/res/res_partner.py
        """
        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warning(
                    ...
                    "https://doc.flectrahq.com/2.0/administration/deployment/deploy.html#https for details.",
                    source
                )
