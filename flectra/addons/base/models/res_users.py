...
from flectra import api, fields, models, tools, SUPERUSER_ID, _, Command
...
from flectra.http import request, DEFAULT_LANG
from flectra.osv import expression
from flectra.service.db import check_super
from flectra.tools import is_html_empty, partition, collections, frozendict, lazy_property
...
class Users(models.Model):
    ...
    def _deactivate_portal_user(self, **post):
        ...
        it removed because they don't use this Flectra portal anymore.
        ...
        if self._on_login_cooldown(failures, previous):
            ...
            if ipaddress.ip_address(source).is_private:
                _logger.warning(
                    ...
                    "https://www.flectrahq.com/documentation/17.0/administration/install/deploy.html#https for details.",
                    source
                )
