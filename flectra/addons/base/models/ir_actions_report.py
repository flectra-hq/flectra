...
from flectra.exceptions import UserError, AccessError, RedirectWarning
        ...
        for stream in streams:
            try:
                ...
                if custom_error_handler:
                    ...
                    continue
                raise UserError(_("Flectra is unable to merge the generated PDFs."))
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        if error_record_ids:
            ...
            raise RedirectWarning(
                message=_('Flectra is unable to merge the generated PDFs because of %(num_errors)s corrupted file(s)', num_errors=num_errors),
                action=action,
