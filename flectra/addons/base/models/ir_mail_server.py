...
from flectra.tools import ustr, pycompat, formataddr, email_normalize, encapsulate_email, email_domain_extract, email_domain_normalize
...
class IrMailServer(models.Model):
    ...
    from_filter = fields.Char(
        ...
        help='Comma-separated list of addresses or domains for which this server can be used.\n'
             'e.g.: "notification@flectrahq.com" or "flectrahq.com"')
    ...
    def connect(self, host=None, port=None, user=None, password=None, encryption=None,
        ...
        """Returns a new SMTP connection to the given SMTP server.
           ...
           :param ssl_certificate: filename of the SSL certificate used for authentication
               Used when no mail server is given and overwrite  the flectra-bin argument "smtp_ssl_certificate"
           :param ssl_private_key: filename of the SSL private key used for authentication
               Used when no mail server is given and overwrite  the flectra-bin argument "smtp_ssl_private_key"
        ...
        # Store the "from_filter" of the mail server / flectra-bin argument to  know if we
    ...
    def _find_mail_server(self, email_from, mail_servers=None):
        ...
        - Mail server to use to send the email (None if we use the flectra-bin arguments)
        ...
        # Skip if passed email_from is False (example Flectrabot has no email address)
        if email_from:
        ...
        # 5: SMTP config in flectra-bin arguments
        from_filter = self.env['ir.mail_server']._get_default_from_filter()
