...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - flectra/addons/test_access_rights/tests/test_feedback.py
        # - flectra/addons/test_access_rights/tests/test_ir_rules.py
        # - flectra/addons/base/tests/test_orm.py (/home/dle/src/flectra/master-nochange-fp/flectra/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.env.registry.clear_cache()
        return res
    ...
    def _make_access_error(self, operation, records):
        ...
        if company_related:
            failing_rules += "\n\n" + _('Note: this might be a multi-company issue. Switching company may help - in Flectra, not in real life!')
