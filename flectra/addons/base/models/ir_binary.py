...
from flectra.exceptions import MissingError, UserError
from flectra.http import Stream, request
from flectra.tools import file_open, replace_exceptions
from flectra.tools.image import image_process, image_guess_size_from_field_name
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:flectra.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~flectra.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`flectra.tools.image.image_process`.
