...
QWeb is the primary templating engine used by Flectra. It is an XML templating
...
<https://www.flectrahq.com/documentation/17.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed flectra user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` Flectra method.
...
from flectra.tools import config, safe_eval, pycompat
from flectra.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from flectra.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from flectra.tools.json import scriptsafe
from flectra.tools.lru import LRU
from flectra.tools.misc import str2bool
from flectra.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from flectra.http import request
from flectra.tools.profiler import QwebTracker
from flectra.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from flectra.addons.base.models.assetsbundle import AssetsBundle
from flectra.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Flectra 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__flectraAssetError=1"
