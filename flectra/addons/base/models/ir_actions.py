...
import flectra
from flectra import api, fields, models, tools, _, Command
from flectra.exceptions import MissingError, ValidationError, AccessError, UserError
from flectra.tools import frozendict
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'UserError': flectra.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
