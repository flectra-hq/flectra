...
from flectra.exceptions import AccessDenied, UserError, ValidationError
from flectra.osv import expression
from flectra.tools.parse_version import parse_version
from flectra.tools.misc import topological_sort, get_flag
from flectra.tools.translate import TranslationImporter, get_po_paths
from flectra.http import request
from flectra.modules import get_module_path
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Flectra 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Flectra 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
