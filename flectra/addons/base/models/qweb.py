...
from flectra.tools.misc import html_escape as escape
from flectra.tools.safe_eval import check_values
    ...
    def _base_module(self):
        ...
        * to_text (empty string for a None or False, otherwise unicode string)
        ...
        return ast.parse(dedent("""
            ...
            from flectra.addons.base.models.qweb import escape, foreach_iterator
            """))
