...
from flectra.http import request, Response, ROUTING_KEYS, Stream
from flectra.modules.registry import Registry
from flectra.service import security
from flectra.tools import get_lang, submap
from flectra.tools.translate import code_translations
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (flectra.exceptions.AccessError, flectra.exceptions.MissingError) as e:
                ...
                if isinstance(e, flectra.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(flectra.conf.server_wide_modules)
    ...
    def _gc_sessions(self):
        if os.getenv("FLECTRA_SKIP_GC_SESSIONS"):
            return
