...
import flectra
from flectra.http import Controller, route, dispatch_rpc, request, Response
from flectra.fields import Date, Datetime, Command
from flectra.tools import lazy, ustr
from flectra.tools.misc import frozendict
...
def xmlrpc_handle_exception_string(e):
    ...
    #InternalError
        ...
        info = sys.exc_info()
        formatted_info = "".join(traceback.format_exception(*info))
        fault = xmlrpc.client.Fault(flectra.tools.exception_to_unicode(e), formatted_info)
