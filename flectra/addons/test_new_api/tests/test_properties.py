...
from flectra.tests.common import Form, TransactionCase, users
from flectra.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('flectra.models.unlink', 'flectra.fields')
    ...
    @users('test')
    @mute_logger('flectra.addons.base.models.ir_rule', 'flectra.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('flectra.addons.test_new_api.models.test_new_api.MultiTag.check_access_rights', _mocked_check_access_rights):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('flectra.addons.test_new_api.models.test_new_api.Discussion.check_access_rights', _mocked_check_access_rights):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('flectra.fields', 'flectra.models.unlink')
