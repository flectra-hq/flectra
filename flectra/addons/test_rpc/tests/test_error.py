...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('flectra.http'):
    ...
    def test_01_create(self):
        ...
        try:
            with mute_logger("flectra.sql_db", "flectra.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("flectra.sql_db"), mute_logger("flectra.http"):
