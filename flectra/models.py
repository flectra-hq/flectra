...
class MetaModel(api.Meta):
    ...
    def __init__(self, name, bases, attrs):
        ...
        if not hasattr(self, '_module'):
            assert self.__module__.startswith('flectra.addons.'), \
                "Invalid import of %s.%s, it should start with 'flectra.addons'." % (self.__module__, name)
...
%(fields_list)s""") % {
    ...
    def _compute_field_value(self, field):
        flectra.fields.determine(field.compute, self)
        ...
        for field, value in sorted(field_values, key=is_monetary):
            ...
            if field.relational:
                ...
                for invf in self._field_inverses[field]:
                    ...
                    # /home/dle/src/flectra/master-nochange-fp/flectra/addons/test_new_api/tests/test_new_fields.py
