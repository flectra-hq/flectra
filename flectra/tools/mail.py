...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~flectra.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within flectra, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within flectra, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@flectrahq.com
    * Output: "Admin" <notifications@flectrahq.com>
    """
