...
class SyncCollector(Collector):
    ...
    Note that --limit-memory-hard may need to be increased when launching Flectra.
    """
    name = 'traces_sync'
    ...
    def __exit__(self, *args):
        try:
            ...
            if self.db:
                ...
                from flectra.sql_db import db_connect  # only import from flectra if/when needed.
