...
from flectra.addons.website_slides.tests import common as slides_common
...
class TestSlidesManagement(slides_common.SlidesCase):
    ...
    def test_default_completion_time(self):
        ...
        with patch(
            'flectra.addons.website_slides.models.slide_slide.Slide._get_completion_time_pdf',
