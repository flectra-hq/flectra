...
import flectra
from flectra import fields, exceptions, Command
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        old_action_post = flectra.addons.account.models.account_move.AccountMove.action_post
        old_create = flectra.models.BaseModel.create
        ...
        post_patch = patch('flectra.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('flectra.models.BaseModel.create', new_create)
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Flectra will create delivery instead of receipt.
