...
from flectra.tools.date_utils import add
...
class TestReorderingRule(TransactionCase):
    ...
    def test_multi_lingual_orderpoints(self):
        ...
        self.assertEqual(len(po_line.order_id.order_line), 1)
        # the moves_dest_ids are not expected to be merged since the scheduler is excuted by robflectra in en_US rather fr_FR
