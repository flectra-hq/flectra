...
from flectra.tests import tagged, TransactionCase
...
class TestWebsitePriceListAvailableGeoIP(TestWebsitePriceListAvailable):
    ...
    def test_get_pricelist_available_geoip(self):
        ...
        with patch('flectra.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code):
            pls = self.website.get_pricelist_available()
    ...
    def test_get_pricelist_available_geoip4(self):
        ...
        with patch('flectra.addons.website_sale.models.website.Website._get_geoip_country_code', return_value=self.BE.code), \
            patch('flectra.addons.website_sale.models.website.Website._get_cached_pricelist_id', return_value=current_pl.id):
            pls = self.website.get_pricelist_available(show_visible=True)
    ...
    def test_get_pricelist_available_geoip5(self):
        ...
        with patch(
            'flectra.addons.website_sale.models.website.Website._get_geoip_country_code',
