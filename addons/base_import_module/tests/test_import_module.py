...
class TestImportModule(flectra.tests.TransactionCase):
    ...
    def test_import_zip(self):
        ...
        with self.assertLogs('flectra.addons.base_import_module.models.ir_module') as log_catcher:
            ...
            self.assertIn('INFO:flectra.addons.base_import_module.models.ir_module:module foo: no translation for language fr_FR', log_catcher.output)
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with (
            mute_logger("flectra.addons.base_import_module.models.ir_module"),
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('flectra.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
            self.assertIn("INFO:flectra.addons.base_import_module.models.ir_module:module foo: skip unsupported file res.partner.xls", log_catcher.output)
            self.assertIn("INFO:flectra.addons.base_import_module.models.ir_module:Successfully imported module 'foo'", log_catcher.output)
            self.assertFalse(self.env.ref('foo.foo', raise_if_not_found=False))
...
class TestImportModuleHttp(TestImportModule, flectra.tests.HttpCase):
