...
from flectra.modules.module import adapt_version, MANIFEST_NAMES
from flectra.osv.expression import is_leaf
...
from flectra.tools import file_open, file_open_temporary_directory, ormcache
from flectra.tools.translate import get_po_paths_env, TranslationImporter

_logger = logging.getLogger(__name__)

APPS_URL = "https://apps.flectrahq.com"
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            description += _(
                ...
                "https://www.flectrahq.com/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/flectra/design-themes.\n"
            )
        elif modules:
