...
from flectra import fields, models, api, _, Command
from flectra.exceptions import UserError
from flectra.tools import float_repr, date_utils
from flectra.tools.xml_utils import cleanup_xml_node, find_xml_value
...
class AccountMove(models.Model):
    ...
    def _search_product_for_import(self, item_description):
        # Exported Flectra XML will have item_description = "[default_code] name".
