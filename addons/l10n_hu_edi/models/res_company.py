...
from flectra.addons.l10n_hu_edi.models.l10n_hu_edi_connection import L10nHuEdiConnection, L10nHuEdiConnectionError, XML_NAMESPACES
...
class ResCompany(models.Model):
    ...
    def _l10n_hu_edi_recover_transactions(self, connection):
        ...
        and then we query the last 10 transactions whose transaction IDs are unknown by Flectra. We try to
        match them to invoices in Flectra, and if successful, update the invoice state.
        """
