...
class L10nHuEdiConnection:
    def __init__(self, env):
        ...
        :param env: the Flectra environment
        """
        self.env = env
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Flectra can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'FLECTRA' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Flectra Professional',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': flectra_version,
            'softwareDevName': 'Flectra SA',
            'softwareDevContact': 'andu@flectrahq.com',
