...
class RecurrenceRule(models.Model):
    ...
    @api.model
    def _sync_google2flectra(self, *args, **kwargs):
        synced_recurrences = super()._sync_google2flectra(*args, **kwargs)
    ...
    def _flectra_values(self, google_recurrence, default_reminders=()):
        base_values = dict(self.env['calendar.event']._flectra_values(google_recurrence, default_reminders), need_sync=False)
