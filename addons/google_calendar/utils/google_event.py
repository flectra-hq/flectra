...
from flectra.tools.misc import ReadonlyDict
from flectra.tools.sql import existing_tables
import pytz
import logging
...
class GoogleEvent(abc.Set):
    ...
    def owner(self, env):
        ...
        # (he is the organizer in Google). The "real" owner (in Flectra) is stored as an
