...
import { helpers, constants } from "@flectra/o-spreadsheet";
 ...
 * e.g. in `FLECTRA.PIVOT(1, "amount", "create_date", "1/5/2023")`, the day is interpreted as being the 5th of January 2023,
 * even if the spreadsheet locale is set to French and such a date is usually interpreted as the 1st of May 2023.
 * The reason is FLECTRA.PIVOT functions are currently generated without being aware of the spreadsheet locale.
 *
