...
export class SpreadsheetPivotModel extends PivotModel {
     ...
     * e.g. in `FLECTRA.PIVOT.HEADER(1, "stage_id", "42", "status", "won")`
     *      the last group value is "won".
     *
     * It can also handle positional arguments.
     * e.g. in `FLECTRA.PIVOT.HEADER(1, "#stage_id", 1, "#user_id", 1)`
     *      the last group value is the id of the first user of the first stage.
     *
     * @param {(string | number | boolean)[]} domainArgs FLECTRA.PIVOT.HEADER arguments
     */
    ...
    /**
     * Get the Flectra domain corresponding to the given domain
     */
