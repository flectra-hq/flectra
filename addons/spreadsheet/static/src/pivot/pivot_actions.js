 ...
 * pivot domain args.
 * e.g. =FLECTRA.PIVOT("1", "measure", "country_id", 1) matches a filter on
 * country_id.
 *
 * @returns {boolean}
 */
export function SET_FILTER_MATCHING_CONDITION(position, env) {
    ...
    return (
        (pivotFunction === "FLECTRA.PIVOT" ||
            pivotFunction === "FLECTRA.PIVOT.HEADER" ||
            pivotFunction === "FLECTRA.PIVOT.TABLE") &&
