...
class BadFlectraLinkError extends EvaluationError {
    constructor(menuId) {
        super(
            _t("#LINK"),
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadFlectraLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .add("FlectraMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadFlectraLinkError(menuId);
                    }
                    return {
                        url,
                        label: _t(label),
                ...
                //     return new FlectraMenuLinkCell(id, content, menuId, menuName, properties);
                // },
            })
            .add("FlectraMenuXmlLink", {
                sequence: 66,
