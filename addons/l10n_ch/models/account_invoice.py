...
class AccountInvoice(models.Model):
    ...
    l10n_ch_currency_name = fields.Char(related='currency_id.name', help="The name of this invoice's currency", readonly=True) #This field is used in the "invisible" condition field of the 'Print ISR' button.
