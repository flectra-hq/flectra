 ...
 */
function setup() {
    env = flectra.__WOWL_DEBUG__.root.env;
    ...
    menuIndex = 0;
    subMenuIndex = 0;
    isEnterprise = flectra.info && flectra.info.isEnterprise;
}
...
async function _clickEverywhere(xmlId) {
    ...
    console.log(`Flectra flavor: ${isEnterprise ? "Enterprise" : "Community"}`);
