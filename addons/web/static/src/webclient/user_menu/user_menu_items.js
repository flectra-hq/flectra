...
import { Component, markup } from "@flectra/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.flectrahq.com/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function flectraAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Flectra.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://accounts.flectrahq.com/account", "_blank");
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("flectra_account", flectraAccountItem)
