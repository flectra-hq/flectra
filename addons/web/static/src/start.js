...
import { Component, whenReady } from "@flectra/owl";
...
export async function startWebClient(Webclient) {
    ...
    await whenReady();
    const app = await mountComponent(Webclient, document.body, { name: "Flectra Web Client" });
    const { env } = app;
    Component.env = env;
    ...
    // delete flectra.debug; // FIXME: some legacy code rely on this
