...
import { flectraExceptionTitleMap } from "@web/core/errors/error_dialogs";
import { _t } from "@web/core/l10n/translation";

flectraExceptionTitleMap.forEach((title, exceptionName) => {
...
const sessionExpired = {
    title: _t("Flectra Session Expired"),
...
registry
    ...
    .add("flectra.http.SessionExpiredException", sessionExpired)
