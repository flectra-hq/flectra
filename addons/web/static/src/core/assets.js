...
import { Component, xml, onWillStart, App } from "@flectra/owl";
...
assets.loadBundle = async function loadBundle(desc) {
    ...
    flectra.loader.checkAndReportErrors();
};
 ...
 */
export const templates = new DOMParser().parseFromString("<flectra/>", "text/xml");
/**
