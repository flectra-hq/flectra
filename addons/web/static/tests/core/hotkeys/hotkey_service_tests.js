...
import { Component, useRef, useState, xml } from "@flectra/owl";
...
QUnit.test("hotkey handles wrongly formed KeyboardEvent", async (assert) => {
    ...
    // fake error service so that the flectra qunit handlers don't think that they need to handle the error
