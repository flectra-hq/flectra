...
import { Component, onMounted, xml } from "@flectra/owl";
...
QUnit.module("ActionManager", (hooks) => {
    ...
    QUnit.test("properly load client actions", async function (assert) {
        ...
        // [1] https://github.com/flectra/flectra/blob/1882d8f89f760bd1ff8a2bf0ae798939402647a3/addons/web/static/tests/setup.js#L52
        await nextTick();
        await nextTick();
        assert.strictEqual(
