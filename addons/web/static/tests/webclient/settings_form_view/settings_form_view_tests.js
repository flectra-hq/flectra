...
QUnit.module("SettingsFormView", (hooks) => {
    ...
    QUnit.test("change setting on nav bar click in base settings", async function (assert) {
                ...
                <form string="Settings" class="oe_form_configuration o_base_settings" js_class="base_settings">
                    <app string="CRM" name="crm">
                        ...
                        <block title="Title of group Foo">
                            <setting help="this is foo" documentation="https://www.flectrahq.com/documentation/1.0/applications/technical/web/settings/this_is_another_test.html">
                                <field name="foo"/>
                            </setting>
        ...
        assert.strictEqual(
            docLinks[1].href,
            "https://www.flectrahq.com/documentation/1.0/applications/technical/web/settings/this_is_another_test.html"
        );
