    ...
    var QWebHighlightRules = function () {
        ...
        this.$rules = Object.assign({},
            xmlRules,
            {
                ...
                attributes_flectra: [{
                    token: ["entity.other.attribute-name.xml.flectra", "keyword.operator.attribute-equals.xml", "text", "string.attribute-value.xml.start", "string.attribute-value.xml.code", "string.attribute-value.xml.end"],
