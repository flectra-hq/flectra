...
class MailBot(models.AbstractModel):
    ...
    def _apply_logic(self, record, values, command=None):
        ...
        if len(record) != 1 or values.get("author_id") == flectrabot_id or values.get("message_type") != "comment" and not command:
            return
    ...
    def _get_answer(self, record, body, values, command=False):
        ...
        if self._is_bot_in_private_channel(record):
            ...
            if flectrabot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return Markup(_("Great! 👍<br/>To access special commands, <b>start your sentence with</b> <span class=\"o_flectrabot_command\">/</span>. Try getting help."))
            elif flectrabot_state == 'onboarding_command' and command == 'help':
                self.env.user.flectrabot_state = "onboarding_ping"
                self.env.user.flectrabot_failed = False
                return Markup(_("Wow you are a natural!<br/>Ping someone with @username to grab their attention. <b>Try to ping me using</b> <span class=\"o_flectrabot_command\">@FlectraBot</span> in a sentence."))
            ...
            # help message
                ...
                return Markup(_("Unfortunately, I'm just a bot 😞 I don't understand! If you need help discovering our product, please check "
                         "<a href=\"https://www.flectrahq.com/documentation\" target=\"_blank\">our documentation</a> or "
                ...
                if flectrabot_state == 'onboarding_emoji':
                    ...
                    return Markup(_("Not exactly. To continue the tour, send an emoji: <b>type</b> <span class=\"o_flectrabot_command\">:)</span> and press enter."))
                    ...
                    self.env.user.flectrabot_failed = True
                    return Markup(_("Not sure what you are doing. Please, type <span class=\"o_flectrabot_command\">/</span> and wait for the propositions. Select <span class=\"o_flectrabot_command\">help</span> and press enter"))
                elif flectrabot_state == 'onboarding_ping':
                    self.env.user.flectrabot_failed = True
                    return Markup(_("Sorry, I am not listening. To get someone's attention, <b>ping him</b>. Write <span class=\"o_flectrabot_command\">@FlectraBot</span> and select me."))
                return random.choice([
                    Markup(_("I'm not smart enough to answer your question.<br/>To follow my guide, ask: <span class=\"o_flectrabot_command\">start the tour</span>.")),
                    _("Hmmm..."),
                    _("I'm afraid I don't understand. Sorry!"),
                    Markup(_("Sorry I'm sleepy. Or not! Maybe I'm just trying to hide my unawareness of human language...<br/>I can show you features if you write: <span class=\"o_flectrabot_command\">start the tour</span>."))
                ])
        return False
