...

{
    ...
    'website': 'https://flectrahq.com/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_flectra_menu.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoomflectra/zoomflectra.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoomflectra/zoomflectra.js',
        ...
        'website.assets_wysiwyg': [
            ...
            'website/static/src/js/editor/flectra_editor.js',
        ],
