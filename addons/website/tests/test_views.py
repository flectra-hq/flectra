...
from flectra.modules.module import _DEFAULT_MANIFEST
...
class TestCowViewSaving(TestViewSavingCommon):
    ...
    def test_view_to_translate_tag(self):
        ...
        with patch('flectra.addons.website.models.ir_http.get_request_website', lambda: website):
...
class TestThemeViews(common.TransactionCase):
    def test_inherit_specific(self):
        ...
        patcher = patch('flectra.modules.module._get_manifest_cached', return_value=copy.deepcopy(_DEFAULT_MANIFEST))
