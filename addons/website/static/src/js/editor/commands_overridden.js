...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/flectra-editor/src/utils/sanitize";
 ...
 */
Text.prototype.oEnterFlectraEditor = Text.prototype.oEnter;
Text.prototype.oEnter = function (offset) {
    ...
    this.oEnterFlectraEditor(...arguments);
};
 ...
 */
HTMLElement.prototype.oDeleteBackwardFlectraEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardFlectraEditor(...arguments);
};
