...
import * as FlectraEditorLib from "@web_editor/js/editor/flectra-editor/src/utils/utils";
import { Component, onMounted, useRef, useState } from "@flectra/owl";
import { throttleForAnimation } from "@web/core/utils/timing";
import { switchTextHighlight } from "@website/js/text_processing";

const getDeepRange = FlectraEditorLib.getDeepRange;
const getTraversedNodes = FlectraEditorLib.getTraversedNodes;
...
const wSnippetMenu = weSnippetEditor.SnippetsMenu.extend({
    ...
    _getDragAndDropOptions(options = {}) {
        // TODO: This is currently not in use by Flectra's D&D
        // There is currently no way in Flectra D&D to offset the edge scrolling.
     ...
     */
    _getSelection() {
        return this.options.wysiwyg.flectraEditor.document.getSelection();
    },
    /**
     * @override
     */
    _addToolbar() {
        ...
        this.options.wysiwyg.flectraEditor.computeFontSizeSelectorValues();
    },
    /**
    * @override
    */
    ...
    _handleTextOptions(targetEl, optionClassList, applyTextOption = () => {}) {
        ...
        if (selectedTextEl) {
            const restoreCursor = FlectraEditorLib.preserveCursor(this.$body[0].ownerDocument);
            ...
            this.options.wysiwyg.flectraEditor.historyResetLatestComputedSelection();
