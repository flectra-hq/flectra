...
registry.slider = publicWidget.Widget.extend({
    ...
    start: function () {
        ...
        if (this.editableMode && this.el.matches("section > .carousel")
            ...
            this.options.wysiwyg.flectraEditor.observerUnactive("disable_controls");
            ...
            this.options.wysiwyg.flectraEditor.observerActive("disable_controls");
    ...
    destroy: function () {
        ...
        this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerUnactive("destroy");
        this.$(".carousel-item")
            .toArray()
            .forEach((el) => {
                $(el).css("min-height", "");
            });
        this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerActive("destroy");
        $(window).off('.slider');
        ...
        if (this.editableMode && this.el.matches("section > .carousel")
            ...
            const indicatorEls = this.el.querySelectorAll(".carousel-indicators > li");
            this.options.wysiwyg.flectraEditor.observerUnactive("restore_controls");
            ...
            this.options.wysiwyg.flectraEditor.observerActive("restore_controls");
            [...this.controlEls, ...indicatorEls].forEach(controlEl => {
    ...
    _computeHeights: function () {
        ...
        this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerUnactive("_computeHeights");
        ...
        this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerActive("_computeHeights");
    },
...
registry.Parallax = Animation.extend({
    ...
    _updateBgCss(cssValues) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.flectraEditor.observerUnactive('_updateBgCss');
        }
        this.$bg.css(cssValues);
        if (this.options.wysiwyg) {
            this.options.wysiwyg.flectraEditor.observerActive('_updateBgCss');
        }
    },
...
registry.ImagesLazyLoading = publicWidget.Widget.extend({
    ...
    _updateImgMinHeight(imgEl, reset = false) {
        if (this.options.wysiwyg) {
            this.options.wysiwyg.flectraEditor.observerUnactive('_updateImgMinHeight');
        }
        if (reset) {
        ...
        if (this.options.wysiwyg) {
            this.options.wysiwyg.flectraEditor.observerActive('_updateImgMinHeight');
        }
    },
});
...
￼    */
    _setImgSrc(svg, resolve) {
        ...
        preloadedImg.onload = () => {
            ...
            this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerUnactive("setImgHoverEffectSrc");
            ...
            this.options.wysiwyg && this.options.wysiwyg.flectraEditor.observerActive("setImgHoverEffectSrc");
