...
import { useRef, useState, useSubEnv, Component, onWillStart, onMounted } from "@flectra/owl";
...
export class AddPageConfirmDialog extends Component {
    ...
    async addPage() {
        const params = {'add_menu': this.state.addMenu || '', csrf_token: flectra.csrf_token};
