...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/flectra-editor/src/utils/utils';
...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL flectrahq.com",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'text flectrahq.com'
    },
    clickOnImgStep,
    {
        content: "Select the newly created link",
        trigger: 'iframe #wrap .s_text_image a[href="http://flectrahq.com"]:contains("flectrahq.com")',
        run() {
    ...
    },
    {
        ...
        trigger: 'iframe .popover:contains("http://flectrahq.com") a .fa-chain-broken',
    },
    {
        content: "Check that the link was removed",
        trigger: 'iframe #wrap .s_text_image p:contains("Go to flectra:"):not(:has(a))',
        run: () => {}, // It's a check.
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: 'iframe .s_text_image a[href="http://flectrahq.com"]:contains("flectrahq.com")',
    },
    {
        content: "Change content (editing the label input) to flectra website_2",
        trigger: '#o_link_dialog_label_input:propValue(flectrahq.com)',
        run: 'text flectra website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://flectrahq.com"]:contains("flectra website_2")',
    },
    {
        content: "Change content (editing the DOM) to flectra website",
        trigger: 'iframe .s_text_image a[href="http://flectrahq.com"]:contains("flectra website_2")',
        run: 'text flectra website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://flectrahq.com"]:contains("flectra website")',
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:propValue(flectra website)',
        isCheck: true,
    },
    {
        content: "Link tools, should be open, change the url",
        trigger: '#o_link_dialog_url_input',
        run: 'text_blur flectra.be'
    },
    ...
    {
        content: "The new link content should be flectra website and url flectra.be",
        trigger: 'iframe .s_text_image a[href="http://flectra.be"]:contains("flectra website")',
    },
    {
        content: "The new link content should be flectra website and url flectra.be",
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        trigger: 'iframe .s_text_image a.btn.btn-secondary[href="http://flectra.be"]:contains("flectra website")',
        isCheck: true,
    },
    // 4. Add link on image.
    ...wTourUtils.clickOnEditAndWaitEditMode(),
    ...
    },
    {
        ...
        trigger: 'iframe .popover div a:contains("http://flectrahq.com")',
        isCheck: true,
    },
    ...wTourUtils.clickOnSave(),
    {
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.flectrahq.com",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.flectrahq.com']:has(img):has(h4):has(span)",
        isCheck: true,
    },
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(flectrahq.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://flectrahq.com']:contains('flectrahq.com')",
        isCheck: true,
    },
    {
    ...
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://flectrahq.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://flectrahq.com']:contains('flectrahq.com')",
        isCheck: true,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://flectrahq.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://flectrahq.com']:contains('flectrahq.com')",
    ...
    // TODO this step which was added by https://github.com/flectra/flectra/commit/9fc283b514d420fdfd66123845d9ec3563572692
