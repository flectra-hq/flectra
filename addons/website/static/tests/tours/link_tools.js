...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Label value should contain flectrahq.com",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'flectrahq.com') {
                throw new Error('Label value should contain flectrahq.com');
            }
        },
    },
    {
    ...
    {
        content: "Label value should contain flectra website",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'flectra website') {
                throw new Error('Label value should contain flectra website');
            }
        },
    },
    {
