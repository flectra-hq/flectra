...
wTourUtils.registerWebsitePreviewTour('snippet_social_media', {
    ...
    ...addNewSocialNetwork(9, 8, 'https://instagr.am/flectra.official/'),
    {
        ...
        trigger: "iframe .s_social_media" +
                 ...
                 ":has(a:eq(8)[href='https://instagr.am/flectra.official/']:has(i.fa-instagram))",
        run: () => {}, // This is a check.
    },
    ...
    },
    {
        ...
        run: 'text_blur https://instagram.com/flectra.official/',
    },
