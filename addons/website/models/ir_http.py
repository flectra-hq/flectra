...
from flectra.addons.http_routing.models import ir_http
from flectra.addons.http_routing.models.ir_http import _guess_mimetype
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(flectra.conf.server_wide_modules)
