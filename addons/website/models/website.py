...
from flectra import api, fields, models, tools, http, release, registry
from flectra.addons.http_routing.models.ir_http import RequestUID, slugify, url_for
from flectra.addons.website.models.ir_http import sitemap_qs2dom
from flectra.addons.website.tools import similarity_score, text_from_html, get_base_domain
from flectra.addons.portal.controllers.portal import pager
from flectra.addons.iap.tools import iap_tools
from flectra.exceptions import AccessError, MissingError, UserError, ValidationError
from flectra.http import request
from flectra.modules.module import get_manifest
from flectra.osv.expression import AND, OR, FALSE_DOMAIN, get_unaccent_wrapper
from flectra.tools.translate import _, xml_translate
from flectra.tools import escape_psql, pycompat
...
DEFAULT_WEBSITE_ENDPOINT = 'https://website.api.flectrahq.com'
DEFAULT_OLG_ENDPOINT = 'https://olg.api.flectrahq.com'
...
class Website(models.Model):
    ...
    def get_website_page_ids(self):
        if not self.env.user.has_group('website.group_website_restricted_editor'):
            ...
            # (website.page) can't be access. It's how the Flectra framework works.
