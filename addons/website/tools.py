...
import flectra
from flectra.tests.common import HttpCase, HOST
from flectra.tools.misc import hmac, DotDict, frozendict
...
def MockRequest(
    ...
    request = Mock(
        ...
        type='http',
        future_response=flectra.http.FutureResponse(),
        params={},
        redirect=env['ir.http']._redirect,
        session=DotDict(
            flectra.http.get_default_session(),
            geoip={'country_code': country_code},
            sale_order_id=sale_order_id,
            website_sale_current_pl=website_sale_current_pl,
            context={'lang': ''},
        ),
        geoip=flectra.http.GeoIP('127.0.0.1'),
    ...
    #
    #   router = flectra.http.root.get_db_router()
