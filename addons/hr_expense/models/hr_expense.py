...
from flectra import api, fields, Command, models, _
from flectra.exceptions import UserError, ValidationError
from flectra.tools.misc import format_date
from flectra.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default flectra rate when the following change:
