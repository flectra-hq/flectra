...
registry.category("web_tour.tours").add('hr_expense_tour' , {
    ...
    extra_trigger: '.o_hr_expense_form_view_view',
    content: markup(_t("Ready? You can save it manually or discard modifications from here. You don't <em>need to save</em> - Flectra will save eveyrthing for you when you navigate.")),
    position: 'bottom',
