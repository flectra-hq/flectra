...
functionRegistry.add("FLECTRA.DEBIT", {
...
functionRegistry.add("FLECTRA.BALANCE", {
...
functionRegistry.add("FLECTRA.FISCALYEAR.START", {
...
functionRegistry.add("FLECTRA.FISCALYEAR.END", {
...
functionRegistry.add("FLECTRA.ACCOUNT.GROUP", {
