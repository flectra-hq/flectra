...
class TestMailingControllers(TestMailingControllersCommon):
    ...
    @mute_logger('flectra.http', 'flectra.addons.website.models.ir_ui_view')
...
class TestMailingTracking(TestMailingControllersCommon):
    ...
    @mute_logger('flectra.addons.mail.models.mail_mail', 'flectra.addons.mass_mailing.models.mailing')
