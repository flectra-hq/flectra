...
class TestMassMailingShortener(common.TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('flectra.addons.link_tracker.models.link_tracker.link_tracker._compute_favicon', wraps=_compute_favicon)
        patcher2 = patch('flectra.addons.link_tracker.models.link_tracker.link_tracker._get_title_from_url', wraps=_get_title_from_url)
        patcher.start()
        patcher2.start()
