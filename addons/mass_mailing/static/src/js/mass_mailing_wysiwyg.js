...
import { closestElement } from "@web_editor/js/editor/flectra-editor/src/FlectraEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.flectraEditor.toolbar = this.toolbarEl;
        this.flectraEditor.autohideToolbar = !!fold;
    ...
    async _createSnippetsMenuInstance(options={}) {
        ...
        const { MassMailingSnippetsMenu }  = await flectra.loader.modules.get('@mass_mailing/js/snippets.editor');
