...
from flectra.addons.project.tests.test_project_profitability import TestProjectProfitabilityCommon
from flectra.addons.purchase.tests.test_purchase_invoice import TestPurchaseToInvoiceCommon
