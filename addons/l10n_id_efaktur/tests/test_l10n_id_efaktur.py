...
from flectra.addons.l10n_id_efaktur.models.account_move import FK_HEAD_LIST, LT_HEAD_LIST, OF_HEAD_LIST, _csv_row, AccountMove
...
class TestIndonesianEfaktur(common.TransactionCase):
    def setUp(self):
        ...
        patch_kode_transaksi = patch('flectra.addons.l10n_id_efaktur_coretax.models.account_move.AccountMove._compute_need_kode_transaksi',
                                AccountMove._compute_need_kode_transaksi)
        self.startClassPatcher(patch_kode_transaksi)
        patch_download_efaktur = patch("flectra.addons.l10n_id_efaktur_coretax.models.account_move.AccountMove.download_efaktur",
