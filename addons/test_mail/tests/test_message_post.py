...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. flectrabot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
    ...
    @users('employee')
    @mute_logger('flectra.addons.mail.models.mail_mail', 'flectra.addons.mail.models.mail_message_schedule', 'flectra.models.unlink')
    ...
    @mute_logger('flectra.addons.mail.models.mail_mail', 'flectra.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('flectra.addons.base.models.ir_model', 'flectra.addons.mail.models.mail_mail')
