...
from flectra.addons.mail.wizard.mail_compose_message import MailComposer
...
from flectra.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @mute_logger('flectra.tests', 'flectra.addons.base.models.ir_rule', 'flectra.addons.mail.models.mail_mail', 'flectra.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('flectra.models.unlink', 'flectra.addons.mail.models.mail_mail', 'flectra.addons.mail.models.mail_message_schedule')
                        ...
                        self.assertMailMail(
                            ...
                            email_values={
                                'headers': {
                                    ...
                                    'X-Flectra-Objects': f'{record._name}-{record.id}',
                                },
