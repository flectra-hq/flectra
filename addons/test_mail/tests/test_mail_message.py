...
from flectra.tools import is_html_empty, mute_logger, formataddr
...
class TestMessageValues(MailCommon):
    ...
    @mute_logger('flectra.models.unlink', 'flectra.addons.mail.models.models')
    @users('employee')
...
class TestMessageAccess(MailCommon):
    ...
    @mute_logger('flectra.addons.base.models.ir_model', 'flectra.addons.base.models.ir_rule')
