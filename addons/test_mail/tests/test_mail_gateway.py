...
class TestMailgateway(MailCommon):
    ...
    @mute_logger('flectra.addons.mail.models.mail_thread', 'flectra.addons.mail.models.mail_mail')
    ...
    def test_routing_loop_alias(self):
        ...
        with self.mock_mail_gateway():
            self.format_and_process(
                ...
                extra='References: <test-1337-loop-detection-bounce-email@flectrahq.com>',
            )
