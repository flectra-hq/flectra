        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    ...
                    'references': f'{email.message_id} {log.message_id} {reply.message_id}',  # should contain reference to FlectraExternal message, logs to fill up history
                },
                'fields_values': {
    ...
    def test_routing_reply_internal_messages(self):
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    'message_id': reply.message_id,
                    'references': f'{log.message_id} {flectraext_msg.message_id} {reply.message_id}',  # should contain reference to FlectraExternal message
                },
                'fields_values': {
        ...
        self.assertMailNotifications(
            ...
            [{
                ...
                'email_values': {
                    ...
                    'references': f'{log.message_id} {flectraext_msg.message_id} {reply.message_id} {reply_2.message_id}',  # should contain reference to FlectraExternal message
                },
                'fields_values': {
