...
# Original Copyright 2015 Eezee-It, modified and maintained by Flectra.
...
from flectra.addons.payment_sips.const import RESPONSE_CODES_MAPPING, SUPPORTED_CURRENCIES
