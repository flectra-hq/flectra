...
from flectra.tests import tagged, TransactionCase, Form
from flectra.tools import mute_logger

from flectra.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'flectra.addons.product.models.product_product.ProductProduct._filter_to_unlink',
