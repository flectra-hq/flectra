...
from flectra.addons.website_forum.models.forum_forum import MOST_USED_TAGS_COUNT
from flectra.addons.website_forum.tests.common import KARMA, TestForumCommon
