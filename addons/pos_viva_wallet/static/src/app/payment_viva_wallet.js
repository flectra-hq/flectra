...
export class PaymentVivaWallet extends PaymentInterface {
    ...
    */
    ...
    _handle_flectra_connection_failure(data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Flectra server, please check your internet connection and try again."
            )
        );
    ...
    async handleVivaWalletStatusResponse() {
        ...
        if (!notification) {
            this._handle_flectra_connection_failure();
            return;
        }
