...
class TestAccessRights(TransactionCase):
    ...
    def test_meeting_edit_access_notification_handle_in_flectra(self):
        # set notifications to "handle in Flectra" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Flectra" notification setting can
