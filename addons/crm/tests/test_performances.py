...
from flectra.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('flectra.models.unlink', 'flectra.addons.crm.models.crm_team', 'flectra.addons.crm.models.crm_team_member')
