...
from flectra.addons.base.models.res_partner import Partner
from flectra.addons.mail.tests.common import MailCommon, mail_new_test_user
from flectra.tests.common import Form, tagged, users
...
class TestPartner(MailCommon):
    ...
    @users('admin')
    @mute_logger('flectra.addons.base.partner.merge', 'flectra.tests')
