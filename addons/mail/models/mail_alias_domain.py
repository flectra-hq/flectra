...
from flectra.addons.mail.models.mail_alias import dot_atom_text
...
class AliasDomain(models.Model):
    ...
    name = fields.Char(
        'Name', required=True,
        help="Email domain e.g. 'example.com' in 'flectra@example.com'")
    ...
    def _migrate_icp_to_domain(self):
        ...
        not be lost (flectra.sh use case). """
