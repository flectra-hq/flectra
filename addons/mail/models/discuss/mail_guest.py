...
import flectra
from flectra.tools import consteq, get_lang
from flectra import _, api, fields, models
from flectra.http import request
from flectra.addons.base.models.res_partner import _tz_get
from flectra.exceptions import UserError
from flectra.addons.bus.models.bus_presence import AWAY_TIMER, DISCONNECTION_TIMER
from flectra.addons.bus.websocket import wsrequest
...
class MailGuest(models.Model):
    ...
    def _init_messaging(self):
        self.ensure_one()
        # sudo: res.partner - exposing FlectraBot name and id
        flectrabot = self.env.ref('base.partner_root').sudo()
    ...
    def _guest_format(self, fields=None):
        ...
        for guest in self:
            ...
            if "write_date" in fields:
                data["write_date"] = flectra.fields.Datetime.to_string(guest.write_date)
            data['type'] = "guest"
