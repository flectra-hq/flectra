...
from flectra import _, api, fields, models, tools, Command
from flectra.addons.base.models.avatar_mixin import get_hsl_from_seed
from flectra.exceptions import UserError, ValidationError
from flectra.osv import expression
from flectra.tools import html_escape, get_lang
from flectra.tools.misc import babel_locale_parse, DEFAULT_SERVER_DATETIME_FORMAT

_logger = logging.getLogger(__name__)

channel_avatar = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 530.06 530.06">
<circle cx="265.03" cy="265.03" r="265.03" fill="#009efb"/>
...
class Channel(models.Model):
    ...
    def _generate_avatar(self):
        ...
        avatar = avatar.replace('fill="#009efb"', f'fill="{bgcolor}"')
