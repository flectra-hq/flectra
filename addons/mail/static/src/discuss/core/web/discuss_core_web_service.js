    ...
    setup() {
        ...
        this.env.bus.addEventListener(
            ...
            ({ detail: { channel, message } }) => {
                ...
                if (channel.correspondent?.eq(this.store.flectrabot) && this.store.flectrabotOnboarding) {
                    // this cancels flectrabot onboarding auto-opening of chat window
                    this.store.flectrabotOnboarding = false;
                    return;
                }
