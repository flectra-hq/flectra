...
/**
 * @return {Promise<{ SfuClient: import("@mail/static/libs/flectra_sfu/flectra_sfu").SfuClient, SFU_CLIENT_STATE: import("@mail/static/libs/flectra_sfu/flectra_sfu").SFU_CLIENT_STATE }>}
 */
const loadSfuAssets = memoize(async () => await loadBundle("mail.assets_flectra_sfu"));
...
export class Rtc {
    ...
    /** @type {import("@mail/static/libs/flectra_sfu/flectra_sfu").SfuClient} */
    sfuClient = undefined;
    ...
    async loadSfuClient() {
        ...
        try {
            await loadSfuAssets();
            const sfuModule = flectra.loader.modules.get("@mail/../lib/flectra_sfu/flectra_sfu");
