...
export class Store extends BaseStore {
    ...
    inPublicPage = false;
    companyName = "";
    flectrabot = Record.one("Persona");
    flectrabotOnboarding;
    users = {};
    ...
    menuThreads = Record.many("Thread", {
        ...
        sort(a, b) {
             ...
             */
            if (a.correspondent?.eq(this.flectrabot) && !b.correspondent?.eq(this.flectrabot)) {
                return 1;
            }
            if (b.correspondent?.eq(this.flectrabot) && !a.correspondent?.eq(this.flectrabot)) {
                return -1;
            }
