...
export class Messaging {
    ...
    initMessagingCallback(data) {
        ...
        this.store.flectrabot = { ...data.flectrabot, type: "partner" };
        ...
        this.store.flectrabotOnboarding = data.flectrabotOnboarding;
    ...
    async searchPartners(searchStr = "", limit = 10) {
        ...
        for (const localId in this.store.Persona.records) {
            ...
            if (
                ...
                ((partner.active && partner.user) || partner === this.store.flectrabot)
            ) {
