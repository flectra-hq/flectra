...
Communicate with your colleagues/customers/guest within Odoo, Flectra.
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'mail/static/lib/**/*',
            ('remove', 'mail/static/lib/flectra_sfu/flectra_sfu.js'),
        ...
        'mail.assets_flectra_sfu': [
            'mail/static/lib/flectra_sfu/flectra_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/flectra_ui_icons/style.css',
