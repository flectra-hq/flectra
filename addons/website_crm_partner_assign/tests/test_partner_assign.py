...
from flectra.addons.website_crm_partner_assign.controllers.main import WebsiteCrmPartnerAssign
...
class TestPartnerLeadPortal(TestCrmCommon):
    ...
    @patch('flectra.http.GeoIP')
    def test_03_crm_partner_assign_geolocalization(self, GeoIpMock):
        """
            This test checks situation when "{FlectraURL}/partners" is visited from foreign country without resellers.
        ...
        """
        # Patch GeoIp so it acts, as if Flectra client is located in Mexico
