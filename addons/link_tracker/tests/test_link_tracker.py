...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.flectrahq.com'
    ...
    def test_absolute_url(self):
        ...
        link_tracker.write({'url': "flectra"})
        # Validate the absolute url is the combination of system parameter and link tracker's url
        self.assertEqual(link_tracker.absolute_url, f'{self._web_base_url}/flectra')
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://flectrahq.com', 'http://example.com', 'http://test.example.com'],
        )
