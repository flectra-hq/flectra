...
from flectra.addons.payment_payulatam.controllers.main import PayuLatamController
from flectra.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'flectra.addons.payment_payulatam.controllers.main.PayuLatamController'
