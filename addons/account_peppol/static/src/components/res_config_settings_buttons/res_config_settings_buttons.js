...
import { Component, markup, useState } from "@flectra/owl";
...
class PeppolSettingsButtons extends Component {
    ...
    showConfirmation(warning, methodName) {
        ...
        const confirmMessage = _t("You will not be able to send or receive Peppol documents in Flectra anymore. Are you sure you want to proceed?");
    ...
    migrate() {
        this.showConfirmation(
            "This will migrate your Peppol registration away from Flectra. A migration key will be generated. \
