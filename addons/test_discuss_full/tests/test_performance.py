...
from flectra.tests.common import users, tagged, HttpCase, warmup
...
class TestDiscussFullPerformance(HttpCase):
    ...
    def test_init_messaging(self):
        ...
        with patch("flectra.http.GeoIP.country_code", new_callable=PropertyMock(return_value=self.env.ref('base.be').code)):
