...
from flectra.tools import is_html_empty, email_normalize
...
class Meeting(models.Model):
    ...
    def create(self, vals_list):
        ...
        # Forbid recurrence creation in Flectra, suggest its creation in Outlook due to the spam limitation.
            ...
            if not sender_sync_status and current_sync_status:
                raise ValidationError(
                    _("For having a different organizer in your event, it is necessary that "
                      "the organizer have its Flectra Calendar synced with Outlook Calendar."))
    ...
    def _forbid_recurrence_update(self):
        ...
        if any(not record.microsoft_id for record in self):
            # If any event is not synced, suggest deleting it in Flectra and recreating it in Outlook.
            error_msg = _(
                "Due to an Outlook Calendar limitation, recurrence updates must be done directly in Outlook Calendar.\n"
                "If this recurrence is not shown in Outlook Calendar, you must delete it in Flectra Calendar and recreate it in Outlook Calendar.")
    ...
    def write(self, values):
        ...
        # Forbid recurrence updates through Flectra and suggest user to update it in Outlook.
    ...
    def _get_microsoft_sync_domain(self):
        ...
        # Define 'custom_lower_bound_range' param for limiting old events updates in Flectra and avoid spam on Microsoft.
