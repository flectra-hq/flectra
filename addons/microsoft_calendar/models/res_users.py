...
from flectra.addons.microsoft_account.models.microsoft_service import DEFAULT_MICROSOFT_TOKEN_ENDPOINT
...
class User(models.Model):
    ...
    def _set_ICP_first_synchronization_date(self, now):
        ...
        created Flectra events and thus avoid spamming invitations for those events.
        """
