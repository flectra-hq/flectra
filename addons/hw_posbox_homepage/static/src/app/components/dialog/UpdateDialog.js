...
export class UpdateDialog extends Component {
    ...
    async getVersionInfo() {
        if (!this.store.isLinux) {
            this.state.flectraIsUpToDate = true;
        ...
        try {
            ...
            this.state.flectraIsUpToDate = data.flectraIsUpToDate;
    ...
    get everythingIsUpToDate() {
        return this.state.flectraIsUpToDate && this.state.imageIsUpToDate;
    }
    ...
    static template = xml`
        ...
        <BootstrapDialog identifier="'update-configuration'" btnName="'Update'" onOpen.bind="getVersionInfo" onClose.bind="onClose">
            <t t-set-slot="header">
                <div>
                    Update
                    <a href="https://www.flectrahq.com/documentation/17.0/applications/general/iot/config/updating_iot.html" class="fa fa-question-circle text-decoration-none text-dark" target="_blank"></a>
                </div>
            </t>
            <t t-set-slot="body">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-else="" class="alert alert-warning small mb-0">
                        ...
                        <a href="https://www.flectrahq.com/documentation/17.0/applications/general/iot/config/updating_iot.html#flashing-the-sd-card-on-iot-box" target="_blank" class="alert-link">
                ...
                <div class="mb-3" t-if="this.store.isLinux">
                    ...
                    <div t-if="this.state.flectraIsUpToDate" class="text-success px-2 small">
                    ...
                    <div t-if="this.store.dev" class="alert alert-light small">
                        Current: 
                        <a t-att-href="'https://github.com/flectra/flectra/commit/' + this.state.currentCommitHash" target="_blank" class="alert-link">
