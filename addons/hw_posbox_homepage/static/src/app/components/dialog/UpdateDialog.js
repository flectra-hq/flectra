        ...
        <BootstrapDialog identifier="'update-configuration'" btnName="'Update'" onOpen.bind="getUpgradeData" onClose.bind="onClose">
            ...
            <t t-set-slot="body">
                ...
                <div class="alert alert-warning fs-6" role="alert">
                    ...
                    <ul>
                        <li>
                            <a href="https://nightly.flectrahq.com/master/iotbox/iotbox-latest.zip">Download the latest image</a>
                        </li>
                        <li>
                            <a href="https://www.flectrahq.com/documentation/17.0/applications/productivity/iot.html">IoTBox manual</a>
                        </li>
                    </ul>
                </div>
