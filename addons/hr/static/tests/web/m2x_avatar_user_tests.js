...
QUnit.module("M2XAvatarUser", ({ beforeEach }) => {
    ...
    QUnit.test("avatar card preview with hr", async (assert) => {
        ...
        const userId = pyEnv["res.users"].create({
            name: "Mario",
            email: "Mario@flectra.test",
            work_email: "Mario@flectra.pro",
            im_status: "online",
            phone: "+78786987",
        ...
        assert.deepEqual(getNodesTextContent(target.querySelectorAll(".o_card_user_infos > *")), ['Mario', 'sub manager', 'Managemment', 'Mario@flectra.pro', '+585555555']);
        // Close card
