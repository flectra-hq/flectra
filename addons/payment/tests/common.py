...
from flectra.tools.misc import hmac as hmac_tool

from flectra.addons.base.tests.common import BaseCommon
...
class PaymentCommon(BaseCommon):
    ...
    def setUp(self):
        ...
        if self.account_payment_installed and self.enable_reconcile_after_done_patcher:
            ...
            self.reconcile_after_done_patcher = patch(
                'flectra.addons.account_payment.models.payment_transaction.PaymentTransaction._reconcile_after_done',
            )
    ...
    def _generate_test_access_token(self, *values):
        ...
        environment of flectra.http.request.
