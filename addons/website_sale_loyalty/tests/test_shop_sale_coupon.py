...
from flectra.addons.sale.tests.test_sale_product_attribute_value_config import (
    TestSaleProductAttributeValueCommon,
)
from flectra.addons.website.tools import MockRequest
from flectra.addons.website_sale_loyalty.controllers.main import WebsiteSale
