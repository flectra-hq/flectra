...
from flectra.addons.payment_ogone.tests.common import OgoneCommon
...
class OgoneTest(OgoneCommon, PaymentHttpCommon):
    ...
    @mute_logger('flectra.addons.payment_ogone.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(OgoneController._return_url)
        with patch(
            'flectra.addons.payment_ogone.controllers.main.OgoneController'
