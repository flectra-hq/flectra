...
class DisplayDriver(Driver):
    ...
    def update_url(self, url=None):
        ...
        # Kill browser instance (can't `instance.pkill()` as we can't keep the instance after Flectra service restarts)
        # We need to terminate it because Flectra will create a new instance each time it is restarted.
