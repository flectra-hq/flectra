...
from flectra.addons.payment_stripe_sca.controllers.main import StripeControllerSCA as StripeController
from flectra.addons.payment_stripe.models.payment import INT_CURRENCIES
