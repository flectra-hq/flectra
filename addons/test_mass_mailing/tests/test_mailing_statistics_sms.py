...
from flectra.addons.test_mass_mailing.tests.common import TestMassSMSCommon
...
class TestMailingStatistics(TestMassSMSCommon):
    ...
    @mute_logger('flectra.addons.mass_mailing_sms.models.mailing_mailing', 'flectra.addons.mail.models.mail_mail', 'flectra.addons.mail.models.mail_thread')
