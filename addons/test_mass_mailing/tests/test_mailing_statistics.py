...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('flectra.addons.mass_mailing.models.mailing', 'flectra.addons.mail.models.mail_mail', 'flectra.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_click(mailing, target_records[0], 'https://www.flectra.be')
        self.gateway_mail_click(mailing, target_records[2], 'https://www.flectra.be')
        self.gateway_mail_click(mailing, target_records[3], 'https://www.flectra.be')
