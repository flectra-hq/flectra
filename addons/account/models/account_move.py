...
from flectra import api, fields, models, _, Command, SUPERUSER_ID
from flectra.addons.account.tools import format_structured_reference_iso
from flectra.exceptions import UserError, ValidationError, AccessError, RedirectWarning
...
from flectra.addons.base_import.models.base_import import FILE_TYPE_DICT
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'Flectra will automatically create one invoice line with default values to match it.',
    )
    ...
    def _get_fields_to_copy_recurring_entries(self, values):
        ...
        values.update({
            ...
            'invoice_user_id': self.invoice_user_id.id,  # otherwise user would be FlectraBot
        })
