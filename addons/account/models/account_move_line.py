...
from flectra import api, fields, models, Command, _
from flectra.exceptions import ValidationError, UserError
from flectra.osv import expression
from flectra.tools import frozendict, format_date, float_compare, Query
from flectra.tools.sql import create_index, SQL
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_flectra_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_flectra_rate(aml, other_aml, counterpart_currency)
