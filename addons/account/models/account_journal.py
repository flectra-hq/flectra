...
from flectra import api, Command, fields, models, _
from flectra.exceptions import UserError, ValidationError
from flectra.addons.base.models.res_bank import sanitize_account_number
from flectra.tools import remove_accents, groupby
...
class AccountJournal(models.Model):
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Flectra.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Flectra.\n"
        "Check: Pay bills by check and print it from Flectra.\n"
    ...
    alias_id = fields.Many2one(help="Send one separate email for each invoice.\n\n"
                                    ...
                                    "Only PDF and XML files will be interpreted by Flectra")
