...
from flectra import fields, Command
from flectra.osv import expression
from flectra.exceptions import ValidationError, RedirectWarning
...
class TestAccountMoveInInvoiceOnchanges(AccountTestInvoicingCommon):
    ...
    def test_in_invoice_onchange_past_invoice_1(self):
        if self.env.ref('purchase.group_purchase_manager', raise_if_not_found=False):
            ...
            # for purchase users
            # https://github.com/flectra/flectra/blob/385884afd31f25d61e99d139ecd4c574d99a1863/addons/purchase/views/account_move_views.xml#L26
