...
from flectra.addons.account.models.chart_template import code_translations, AccountChartTemplate, TEMPLATE_MODELS
...
class TestChartTemplate(TransactionCase):
    ...
    def test_parsed_csv_submodel_being_loaded(self):
        ...
        with patch('flectra.addons.account.models.chart_template.file_open',
