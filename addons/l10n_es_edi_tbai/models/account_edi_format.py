...
from flectra import _, models, release
from flectra.addons.l10n_es_edi_sii.models.account_edi_format import PatchedHTTPAdapter
from flectra.addons.l10n_es_edi_tbai.models.l10n_es_edi_tbai_agencies import get_key
from flectra.addons.l10n_es_edi_tbai.models.xml_utils import (
...
from flectra.tools.float_utils import float_repr, float_round
from flectra.tools.xml_utils import cleanup_xml_node, validate_xml_from_attachment
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_es_tbai_get_header_values(self, invoice):
        return {
            ...
            'flectra_version': release.version,
        }
