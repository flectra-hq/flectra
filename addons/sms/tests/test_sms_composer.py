...
from flectra.addons.sms.models.mail_thread import MailThread
from flectra.addons.sms.tests.common import SMSCommon, SMSCase
...
class TestSMSComposerComment(SMSCommon, SMSCase):
    ...
    def test_message_post_sms_vs_notification(self):
        ...
        cases = [
            (
                'Hello there, check this awesome <b>app</b> I found:<br/>https://flectrahq.com',  # not a `a` link in source
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;<a href="https://flectrahq.com" target="_blank" rel="noreferrer noopener">https://flectrahq.com</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/>https://flectrahq.com'
            ), (
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://flectrahq.com">Here</a>',   # a link
                '<p>Hello there, check this awesome &lt;b&gt;app&lt;/b&gt; I found:&lt;br/&gt;&lt;a href="<a href="https://flectrahq.com%22&gt;Here&lt;/a&gt;" target="_blank" rel="noreferrer noopener">https://flectrahq.com"&gt;Here&lt;/a&gt;</a></p>',
                'Hello there, check this awesome <b>app</b> I found:<br/><a href="https://flectrahq.com">Here</a>'  # keep all information
            )
        ]
    ...
    def test_message_sms_body_sms_vs_notification(self):
        ...
        cases = [
            (
                ...
                '<a href="https://flectrahq.com" target="_blank" rel="noreferrer noopener">https://flectrahq.com</a></p>',
                # same
                '<p>Hello there, check this awesome app I found:<br/>'
                '<a href="https://flectrahq.com" target="_blank" rel="noreferrer noopener">https://flectrahq.com</a></p>',
            ), (
