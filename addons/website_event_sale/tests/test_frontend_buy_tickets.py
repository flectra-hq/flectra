...
from flectra.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
...
class TestRoutes(HttpCaseWithUserDemo, TestWebsiteEventSaleCommon, PaymentHttpCommon):
    ...
    def test_check_seats_avail_before_purchase(self):
        ...
        with self.assertRaisesRegex(flectra.tests.JsonRpcException, 'flectra.exceptions.ValidationError'):
