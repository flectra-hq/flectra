...
from flectra.addons.payment_xendit.controllers.main import XenditController
from flectra.addons.payment_xendit.tests.common import XenditCommon
...
class TestPaymentTransaction(PaymentHttpCommon, XenditCommon):
    ...
    def test_no_input_missing_from_redirect_form(self):
        ...
        with patch(
            'flectra.addons.payment_xendit.models.payment_transaction.PaymentTransaction'
