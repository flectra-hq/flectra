...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            'web/static/lib/flectra_ui_icons/*',
            ...
            'web/static/lib/owl/flectra_module.js',
            ...
            # flectra-editor
            'web_editor/static/src/js/editor/flectra-editor/src/utils/utils.js',
            'web_editor/static/src/js/editor/flectra-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/toggleList.js',

            # flectra utils
            'web_editor/static/src/scss/bootstrap_overridden.scss',
            'web/static/src/scss/pre_variables.scss',
            'web/static/lib/bootstrap/scss/_variables.scss',
            'web_editor/static/src/js/editor/flectra-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/flectra-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/flectra-editor/src/checklist.scss',
        ],
        'web_editor.assets_wysiwyg': [
            ...
            # flectra-editor
            'web_editor/static/src/js/editor/flectra-editor/src/FlectraEditor.js',
            'web_editor/static/src/js/editor/flectra-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/flectra-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/flectra-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/flectra-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/flectra-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/flectra-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/flectra-editor/src/commands/deleteForward.js',
        ...
        "web.assets_web_dark": [
            'web_editor/static/src/scss/flectra-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/flectra-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/flectra-editor/tableui.dark.scss',
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/flectra-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/flectra-editor/src/**/*js',
            'web_editor/static/src/js/editor/flectra-editor/test/spec/*js',
            'web_editor/static/src/js/editor/flectra-editor/test/*js',
        ],
    },
    'auto_install': True,
    'license': 'LGPL-3',
