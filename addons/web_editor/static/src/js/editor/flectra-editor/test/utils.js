...
import { FlectraEditor } from '../src/FlectraEditor.js';
...
export async function testEditor(Editor = FlectraEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteFlectraEditorHtml = async (editor, html) => pasteData(editor, html, 'text/flectra-editor');
...
export class BasicEditor extends FlectraEditor {}
