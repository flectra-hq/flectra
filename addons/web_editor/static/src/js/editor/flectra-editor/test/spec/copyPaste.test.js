        ...
        it('should copy the selection as a single list item', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/flectra-editor')).to.be.equal('<li>First</li>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/flectra-editor')).to.be.equal('<li>List</li>');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/flectra-editor')).to.be.equal('<li><span style="font-size: 48px;"><font style="color: rgb(255, 0, 0);">First</font></span></li>');
                },
            });
        })
        ...
        describe('range collapsed', async () => {
            ...
            it('should paste html content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p><a href="www.flectrahq.com">flectrahq.com</a><br><a href="www.google.com">google.com</a>[]</p>',
                });
            });
