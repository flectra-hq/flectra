...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        FlectraEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new FlectraEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    FlectraEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
