...
export class FlectraEditor extends EventTarget {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as flectra-editor utils to avoid this
     ...
     * from outside the flectraEditor.
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('flectra-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const flectraEditorHtml = ev.clipboardData.getData('text/flectra-editor');
