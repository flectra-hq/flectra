...
const getCursorDirection = FlectraEditorLib.getCursorDirection;
const DIRECTIONS = FlectraEditorLib.DIRECTIONS;
...
export class Wysiwyg extends Component {
    ...
    getValue(options) {
        ...
        this.flectraEditor && this.flectraEditor.cleanForSave($editable[0]);
