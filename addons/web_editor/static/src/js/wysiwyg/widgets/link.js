...
import { deduceURLfromText } from "@web_editor/js/editor/flectra-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = FlectraEditorLib;
...
export class Link extends Component {
    ...
    async _updateState(props) {
        ...
        if (this.state.range) {
            this.$link = this.$link || $(FlectraEditorLib.getInSelection(this.editable.ownerDocument, 'a'));
