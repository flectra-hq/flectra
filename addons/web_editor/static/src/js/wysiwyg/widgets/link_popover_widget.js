...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.flectraEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start();
        params.wysiwyg?.flectraEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        .on('show.bs.popover.link_popover', () => {
            this.wysiwyg.flectraEditor.observerUnactive('show.bs.popover');
            this._loadAsyncLinkPreview();
            popoverShown = true;
        })
        .on('inserted.bs.popover', () => {
            this.wysiwyg.flectraEditor.observerActive('show.bs.popover');
        })
        .on('hide.bs.popover.link_popover', () => {
            this.wysiwyg.flectraEditor.observerUnactive('hide.bs.popover');
            popoverShown = false;
        })
        .on('hidden.bs.popover.link_popover', () => {
            this.wysiwyg.flectraEditor.observerActive('hide.bs.popover');
        ...
        if (document !== this.wysiwyg.flectraEditor.document) {
            $(this.wysiwyg.flectraEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.flectraEditor.document).off('.link_popover');
