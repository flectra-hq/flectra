...
export class LinkTools extends Link {
    ...
    applyLinkToDom() {
        ...
        this.props.wysiwyg.flectraEditor.historyStep();
    ...
    _onColorpaletteColorPicked(cssProperty, params) {
        ...
        this.props.wysiwyg.flectraEditor.execCommand('applyColor', '', 'color');
        this.props.wysiwyg.flectraEditor.execCommand('applyColor', '', 'backgroundColor');
    ...
    __onURLInput() {
        ...
        this.props.wysiwyg.flectraEditor.historyPauseSteps('_onURLInput');
        this._syncContent();
        this._adaptPreview();
        this.props.wysiwyg.flectraEditor.historyUnpauseSteps('_onURLInput');
    }
    /**
