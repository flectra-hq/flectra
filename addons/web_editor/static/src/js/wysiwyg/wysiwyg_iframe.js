...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        ...
        this.$editable = $('<div class="note-editable oe_structure flectra-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure flectra-editor-editable');
        if (isEditableRoot) {
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper flectra-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            flectra.define('root.widget', ['@web/legacy/js/core/widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            flectra.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
