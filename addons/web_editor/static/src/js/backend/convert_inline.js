...
import { getAdjacentPreviousSiblings, isBlock, rgbToHex, commonParentGet } from '../editor/flectra-editor/src/utils/utils';
...
export async function toInline($editable, cssRules, $iframe) {
    $editable.removeClass('flectra-editor-editable');
    const editable = $editable.get(0);
    ...
    $editable.addClass('flectra-editor-editable');
}
/**
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const { fonts } = flectra.loader.modules.get("@web_editor/js/wysiwyg/fonts");
