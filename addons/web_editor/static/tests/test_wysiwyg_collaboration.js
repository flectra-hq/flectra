...
import {
    ...
    patchEditorIframe,
} from '@web_editor/js/editor/flectra-editor/test/utils';
...
class PeerTest {
    ...
    async startEditor() {
        ...
        if (this.initialParsedSelection) {
            ...
            this.wysiwyg.flectraEditor._recordHistorySelection();
        } else {
    ...
    async getValue() {
        this.wysiwyg.flectraEditor.observerUnactive('PeerTest.getValue');
        ...
        this.wysiwyg.flectraEditor.observerActive('PeerTest.getValue');
...
export async function createPeers(peers) {
    ...
    for (const peerId of peers) {
        ...
        patch(wysiwyg, {
            ...
            // Hacky hook as we know this method is called after setting the value in the wysiwyg start and before sending the value to flectraEditor.
    ...
    QUnit.module('Collaboration', {}, () => {
        ...
        QUnit.module('Focus', {}, () => {
            QUnit.test('Focused client should not receive step if no data channel is open', async (assert) => {
                ...
                await peers.p1.wysiwyg.flectraEditor.execCommand('insert', 'b');
        ...
        QUnit.module('Stale detection & recovery', {}, () => {
            QUnit.module('detect stale while unfocused', async () => {
                QUnit.test('should do nothing until focus', async (assert) => {
                    ...
                    await peers.p1.wysiwyg.flectraEditor.execCommand('insert', 'c');
        ...
        QUnit.module('Disconnect & reconnect', {}, () => {
            QUnit.test('should sync history when disconnecting and reconnecting to internet', async (assert) => {
                ...
                const setSelection = peer => {
                    ...
                    const pElement = peer.wysiwyg.flectraEditor.editable.querySelector('p')
                ...
                const addP = (peer, content) => {
                    ...
                    peer.wysiwyg.flectraEditor.editable.append(p);
                    peer.wysiwyg.flectraEditor.historyStep();
                }
                ...
                await peers.p2.wysiwyg.flectraEditor.execCommand('insert', 'e');
                addP(peers.p2, 'f');
