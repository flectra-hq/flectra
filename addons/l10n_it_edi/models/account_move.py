...
from flectra import _, api, Command, fields, models
from flectra.addons.base.models.ir_qweb_fields import Markup, nl2br, nl2br_enclose
from flectra.addons.account_edi_proxy_client.models.account_edi_proxy_user import AccountEdiProxyError
from flectra.exceptions import UserError
from flectra.tools import float_compare, float_repr, cleanup_xml_node
...
class AccountMove(models.Model):
    ...
    def _l10n_it_edi_import_invoice(self, invoice, data, is_new):
        """ Decodes a l10n_it_edi move into an Flectra move.
