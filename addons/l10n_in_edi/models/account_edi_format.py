...
from flectra.tools import html_escape, float_is_zero, float_compare
from flectra.exceptions import AccessError, ValidationError
from flectra.addons.iap import jsonrpc
import logging

_logger = logging.getLogger(__name__)

DEFAULT_IAP_ENDPOINT = "https://l10n-in-edi.api.flectrahq.com"
DEFAULT_IAP_TEST_ENDPOINT = "https://l10n-in-edi-demo.api.flectrahq.com"
...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_in_edi_post_invoice(self, invoice):
        ...
        if response.get("error"):
            ...
            if "1005" in error_codes:
                ...
                # This happen when authenticate called from another flectra instance with same credentials (like. Demo/Test)
            ...
            if "2150" in error_codes:
                ...
                if not response.get("error"):
                    ...
                    invoice.message_post(author_id=flectrabot.id, body=Markup(_(
    ...
    def _l10n_in_edi_authenticate(self, company):
        ...
        # validity data-time in Indian standard time(UTC+05:30) so remove that gap and store in flectra
        if "data" in response:
