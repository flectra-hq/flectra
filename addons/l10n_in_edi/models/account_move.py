...
class AccountMove(models.Model):
    ...
    def _l10n_in_edi_is_managing_invoice_negative_lines_allowed(self):
        ...
        or global discounts. This method allows flectra to distribute the negative discount lines to each others lines
        with same HSN code making such features available even for Indian people.
        :return: True if flectra needs to distribute the negative discount lines, False otherwise.
        """
