...
from flectra import http, tools, _, release
from flectra.exceptions import UserError
from flectra.http import request
from flectra.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/flectra_ui_icons', type='http', auth='none', cors="*")
    def flectra_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/flectra_ui_icons/fonts/flectra_ui_icons.woff2').get_response()
