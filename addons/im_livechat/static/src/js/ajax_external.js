...
/**
  * This file should be used in the context of an external widget loading (e.g: live chat in a non-Flectra website)
  ...
  * As we're not in an Flectra website context, the calls will not work, and we avoid a 404 request.
  */
